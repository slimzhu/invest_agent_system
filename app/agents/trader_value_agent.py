...
def build_value_trader_input(
    ...
    if analysis_mode == "single_stock":
        ...
        payload["task"] = (
            ...
            "identify 2 to 6 potentially investable U.S. stocks from a value and quality perspective, with fewer only if evidence is weak and never more than 9 total. "
